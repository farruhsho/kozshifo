...
class KozIcons {
  ...
  static const Map<String, String> paths = {
    ...
    'optics': '<circle cx="6.5" cy="14" r="3.5" stroke="currentColor" stroke-width="1.7"/><circle cx="17.5" cy="14" r="3.5" stroke="currentColor" stroke-width="1.7"/><path d="M10 13.5c.8-1 3.2-1 4 0M3 9l1.5-2M21 9l-1.5-2" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"/>',
    ...
    'cameras': '<rect x="3" y="6" width="13" height="12" rx="2.5" stroke="currentColor" stroke-width="1.7"/><path d="M16 10l5-3v10l-5-3" stroke="currentColor" stroke-width="1.7" stroke-linejoin="round"/>',
