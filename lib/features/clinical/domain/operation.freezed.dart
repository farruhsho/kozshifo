...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Operation&&(identical(other.id, id) || other.id == id)&&(identical(other.visitId, visitId) || other.visitId == visitId)&&(identical(other.patientId, patientId) || other.patientId == patientId)&&(identical(other.patientName, patientName) || other.patientName == patientName)&&(identical(other.referringDoctorId, referringDoctorId) || other.referringDoctorId == referringDoctorId)&&(identical(other.referringDoctorName, referringDoctorName) || other.referringDoctorName == referringDoctorName)&&(identical(other.surgeonId, surgeonId) || other.surgeonId == surgeonId)&&(identical(other.surgeonName, surgeonName) || other.surgeonName == surgeonName)&&(identical(other.operationTypeId, operationTypeId) || other.operationTypeId == operationTypeId)&&(identical(other.typeName, typeName) || other.typeName == typeName)&&(identical(other.eye, eye) || other.eye == eye)&&(identical(other.priority, priority) || other.priority == priority)&&(identical(other.status, status) || other.status == status)&&(identical(other.price, price) || other.price == price)&&(identical(other.scheduledAt, scheduledAt) || other.scheduledAt == scheduledAt)&&(identical(other.performedAt, performedAt) || other.performedAt == performedAt)&&(identical(other.completedAt, completedAt) || other.completedAt == completedAt)&&(identical(other.notes, notes) || other.notes == notes)&&(identical(other.result, result) || other.result == result)&&(identical(other.financiallyClosedAt, financiallyClosedAt) || other.financiallyClosedAt == financiallyClosedAt)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,visitId,patientId,patientName,referringDoctorId,referringDoctorName,surgeonId,surgeonName,operationTypeId,typeName,eye,priority,status,price,scheduledAt,performedAt,completedAt,notes,result,financiallyClosedAt,createdAt]);

@override
String toString() {
  return 'Operation(id: $id, visitId: $visitId, patientId: $patientId, patientName: $patientName, referringDoctorId: $referringDoctorId, referringDoctorName: $referringDoctorName, surgeonId: $surgeonId, surgeonName: $surgeonName, operationTypeId: $operationTypeId, typeName: $typeName, eye: $eye, priority: $priority, status: $status, price: $price, scheduledAt: $scheduledAt, performedAt: $performedAt, completedAt: $completedAt, notes: $notes, result: $result, financiallyClosedAt: $financiallyClosedAt, createdAt: $createdAt)';
}
...
/// Create a copy of Operation
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? visitId = null,Object? patientId = null,Object? patientName = null,Object? referringDoctorId = freezed,Object? referringDoctorName = freezed,Object? surgeonId = freezed,Object? surgeonName = freezed,Object? operationTypeId = null,Object? typeName = null,Object? eye = null,Object? priority = null,Object? status = null,Object? price = freezed,Object? scheduledAt = freezed,Object? performedAt = freezed,Object? completedAt = freezed,Object? notes = freezed,Object? result = freezed,Object? financiallyClosedAt = freezed,Object? createdAt = null,}) {
...
as String?,financiallyClosedAt: freezed == financiallyClosedAt ? _self.financiallyClosedAt : financiallyClosedAt // ignore: cast_nullable_to_non_nullable
...
@override final  String? financiallyClosedAt;
