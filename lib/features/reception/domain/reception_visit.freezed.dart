...
mixin _$ReceptionVisit {
 ...
 String get id; String get visitNo; String? get patientId; String get status; String get flowStatus; String get totalAmount; String get paidAmount; String get balance;// Reception discount (TZ Modul 2.2): percent XOR amount + reason.
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,visitNo,patientId,status,flowStatus,totalAmount,paidAmount,balance,discountPercent,discountAmount,discountReason,discountValue,payable,const DeepCollectionEquality().hash(items));

@override
String toString() {
  return 'ReceptionVisit(id: $id, visitNo: $visitNo, patientId: $patientId, status: $status, flowStatus: $flowStatus, totalAmount: $totalAmount, paidAmount: $paidAmount, balance: $balance, discountPercent: $discountPercent, discountAmount: $discountAmount, discountReason: $discountReason, discountValue: $discountValue, payable: $payable, items: $items)';
}
...
@useResult
$Res call({
 String id, String visitNo, String? patientId, String status, String flowStatus, String totalAmount, String paidAmount, String balance, String? discountPercent, String? discountAmount, String? discountReason, String? discountValue, String? payable, List<ReceptionVisitItem> items
});
...
/// Create a copy of ReceptionVisit
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? visitNo = null,Object? patientId = freezed,Object? status = null,Object? flowStatus = null,Object? totalAmount = null,Object? paidAmount = null,Object? balance = null,Object? discountPercent = freezed,Object? discountAmount = freezed,Object? discountReason = freezed,Object? discountValue = freezed,Object? payable = freezed,Object? items = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String visitNo,  String? patientId,  String status,  String flowStatus,  String totalAmount,  String paidAmount,  String balance,  String? discountPercent,  String? discountAmount,  String? discountReason,  String? discountValue,  String? payable,  List<ReceptionVisitItem> items)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ReceptionVisit() when $default != null:
return $default(_that.id,_that.visitNo,_that.patientId,_that.status,_that.flowStatus,_that.totalAmount,_that.paidAmount,_that.balance,_that.discountPercent,_that.discountAmount,_that.discountReason,_that.discountValue,_that.payable,_that.items);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String visitNo,  String? patientId,  String status,  String flowStatus,  String totalAmount,  String paidAmount,  String balance,  String? discountPercent,  String? discountAmount,  String? discountReason,  String? discountValue,  String? payable,  List<ReceptionVisitItem> items)  $default,) {final _that = this;
switch (_that) {
case _ReceptionVisit():
return $default(_that.id,_that.visitNo,_that.patientId,_that.status,_that.flowStatus,_that.totalAmount,_that.paidAmount,_that.balance,_that.discountPercent,_that.discountAmount,_that.discountReason,_that.discountValue,_that.payable,_that.items);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String visitNo,  String? patientId,  String status,  String flowStatus,  String totalAmount,  String paidAmount,  String balance,  String? discountPercent,  String? discountAmount,  String? discountReason,  String? discountValue,  String? payable,  List<ReceptionVisitItem> items)?  $default,) {final _that = this;
switch (_that) {
case _ReceptionVisit() when $default != null:
return $default(_that.id,_that.visitNo,_that.patientId,_that.status,_that.flowStatus,_that.totalAmount,_that.paidAmount,_that.balance,_that.discountPercent,_that.discountAmount,_that.discountReason,_that.discountValue,_that.payable,_that.items);case _:
  return null;
...
class _ReceptionVisit implements ReceptionVisit {
  const _ReceptionVisit({required this.id, required this.visitNo, this.patientId, required this.status, this.flowStatus = 'registered', required this.totalAmount, required this.paidAmount, required this.balance, this.discountPercent, this.discountAmount, this.discountReason, this.discountValue, this.payable, final  List<ReceptionVisitItem> items = const <ReceptionVisitItem>[]}): _items = items;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,visitNo,patientId,status,flowStatus,totalAmount,paidAmount,balance,discountPercent,discountAmount,discountReason,discountValue,payable,const DeepCollectionEquality().hash(_items));
...
/// Create a copy of ReceptionVisit
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? visitNo = null,Object? patientId = freezed,Object? status = null,Object? flowStatus = null,Object? totalAmount = null,Object? paidAmount = null,Object? balance = null,Object? discountPercent = freezed,Object? discountAmount = freezed,Object? discountReason = freezed,Object? discountValue = freezed,Object? payable = freezed,Object? items = null,}) {
